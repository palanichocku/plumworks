...
export async function createVehicle(formData: FormData) {
  ...
  const vehicle = await prisma.vehicle.create({ data: { shopId: membership.shopId, customerId, year, make, model, engine, licensePlate: licensePlate || null, vin: vin || null, odometer }, select: { id: true } });
