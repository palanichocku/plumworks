...
export function NewRepairOrderForm({
  ...
  const sectionClass = "space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm";

  return (
    <form action={createRepairOrder} className={formClass} data-repair-order-layout="split">
